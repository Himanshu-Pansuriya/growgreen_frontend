...
import about5 from "../img/about-5.jpg"
import about6 from "../img/about-6.jpg"
...
import storeproduct1 from "../img/store-product-1.jpg"
import storeproduct2 from "../img/store-product-2.jpg"
import storeproduct3 from "../img/store-product-3.jpg"
import testemonial1 from"../img/testimonial-1.jpg"
import testemonial2 from"../img/testimonial-2.jpg"
import testemonial3 from"../img/testimonial-3.jpg"
            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid bg-white w-100 mb-3 wow fadeIn" data-wow-delay="0.1s" src={about1} alt=""/>
                            <img class="img-fluid bg-white w-50 wow fadeIn" data-wow-delay="0.2s" src={about3} alt=""/>
                        </div>
                        <div class="col-6">
                            <img class="img-fluid bg-white w-50 mb-3 wow fadeIn" data-wow-delay="0.3s" src={about4} alt=""/>
                            <img class="img-fluid bg-white w-100 wow fadeIn" data-wow-delay="0.4s" src={about2} alt=""/>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-sm-4">
                            <img class="img-fluid bg-white w-100" src={about5} alt=""/>
                        </div>
                        <div class="col-sm-8">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-4">
                            <img class="img-fluid bg-white w-100" src={about6} alt=""/>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid" src={article} alt=""/>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="section-title">
    ...
    <div class="container-fluid video my-5">
        <div class="container">
            <div class="row g-0">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="h-100 d-flex align-items-center justify-content-center" style={{ maxHeight: '300px' }}>
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.5s">
                <div class="testimonial-item p-4 p-lg-5">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <img class="img-fluid flex-shrink-0" src={testemonial1} alt=""/>
                ...
                <div class="testimonial-item p-4 p-lg-5">
                    <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo</p>
                    <div class="d-flex align-items-center justify-content-center">
                        <img class="img-fluid flex-shrink-0" src={testemonial2} alt=""/>
                        <div class="text-start ms-3">
                            <h5>Client Name</h5>
                            <span class="text-primary">Profession</span>
                        </div>
                ...
                <div class="testimonial-item p-4 p-lg-5">
                    <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo</p>
                    <div class="d-flex align-items-center justify-content-center">
                        <img class="img-fluid flex-shrink-0" src={testemonial3} alt=""/>
                        <div class="text-start ms-3">
                            <h5>Client Name</h5>
                            <span class="text-primary">Profession</span>
                        </div>
